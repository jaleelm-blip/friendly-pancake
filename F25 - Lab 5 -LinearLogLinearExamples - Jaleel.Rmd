...
We model a continuous outcome (`sepal.width`) as a linear function of `sepal.length` (Sepal Length) using the **iris** dataset.
...
where  
- \(y_i\) = response (Sepal Width)
- \(x_i\) = predictor (Petal Width)
...
# Predictions for new Sepal Width values
